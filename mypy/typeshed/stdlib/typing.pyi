...
class Mapping(Collection[_KT_co], Generic[_KT_co, _VT_co]):
    ...
    @abstractmethod
    def __getitem__(self, __key: _KT_co) -> _VT_co: ...  # type: ignore[unsafe-variance]
    # Mixin methods
    @overload
    def get(self, __key: _KT_co) -> _VT_co | None: ...  # type: ignore[unsafe-variance]
    @overload
    def get(self, __key: _KT_co, default: _VT_co | _T) -> _VT_co | _T: ...  # type: ignore[unsafe-variance]
